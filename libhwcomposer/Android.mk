...
LOCAL_SHARED_LIBRARIES := liblog libEGL libmemoryheapion libbinder libutils libcutils libUMP libGLESv1_CM libhardware libui
...
LOCAL_CFLAGS += -D_USE_SPRD_HWCOMPOSER -DGL_GLEXT_PROTOTYPES -DEGL_EGLEXT_PROTOTYPES -w
